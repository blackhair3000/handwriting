...
uifile = os.path.join(dir_path,'handwritingUI')
form, base = uic.loadUiType(os.path.join(uifile, "PaintOnAPain.ui"))
...
class CreateUI(base, form):
    ...
    def Establish_Connections(self):
        ...
        self.recognize_button.clicked.connect(self.executeRecogPage)

    def executeRecogPage(self):
        recog_page = RecognizePage()
        recog_page.exec_()
